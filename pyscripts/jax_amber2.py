...
def get_amber_gas_energy_function(fname_prmtop):
    ...
    ener_nbond_fn = ener_nonbonded_pair(atom_types, nonbond_pairs, sigma, epsilon, chgs)

    nbonds14 = prm_get_nonbond14_info(prm_raw_data)
    ener_nbond14_fn = ener_nonbonded14(atom_types, nbonds14, sigma, epsilon, chgs)
    ...
    def gas_energy_function(R):
        """
        Provide n_conf, flattened_coords        
        """
        #print(R.shape)
        R = R.reshape(-1,3)
